...
<div class="card"> 
    ...
    <div class="card-body">
        <form action="{{route('diretor.store')}}" method="POST" class="form-horizontal">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                <input type="text" name="office" value="{{old('office')}}" class="form-control @error('office') is-invalid @enderror">
                </div>
            </div>
            <div class="form-group row">
